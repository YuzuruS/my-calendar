...
function my_calendar_draw_event( $event, $type = "calendar", $process_date, $time, $template = '' ) {
	...
	switch ( $type ) {
		case 'calendar' : $title_template = ( !isset( $templates['title'] ) || $templates['title'] == '' ) ? '{title}' : $templates['title']; break;
		case 'list' : $title_template = ( !isset( $templates['title_list'] ) || $templates['title_list'] == '' ) ? '{title}' : $templates['title_list']; break;
		case 'single' : $title_template = ( !isset( $templates['title_solo'] ) || $templates['title_solo'] == '' ) ? '{title}' : $templates['title_solo']; break;
		default: $title_template = ( !isset( $templates['title'] ) || $templates['title'] == '' ) ? '{title}' : $templates['title'];
	}
